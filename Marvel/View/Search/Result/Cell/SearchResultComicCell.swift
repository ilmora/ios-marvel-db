...
class SearchResultComicCell: UICollectionViewCell {
  ...
  private func setupView() {
    ...
    NSLayoutConstraint.activate([
      ...
      resultTypeImage.heightAnchor.constraint(equalTo: resultTypeImage.widthAnchor, multiplier: 1.5)
    ])
  }
